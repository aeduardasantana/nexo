...
export const verbRules: VerbRule[] = [
  ...
  { id: 'see', label: 'VER', symbol: '👁️', requires: ['actor', 'object'], description: 'Personagem direciona a atenção para um objeto.' },
  ...
  { id: 'bring', label: 'TRAZER', symbol: '⬅️', requires: ['actor', 'object', 'destination'], description: 'Personagem traz um objeto para um local.' },
